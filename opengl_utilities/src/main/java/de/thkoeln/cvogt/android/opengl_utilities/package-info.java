/**
 ...
 <P>
 <LI><I>GLTouchEventCV</I> describing touch events in 3D scenes
 </UL>
 </UL>
 <P>
 ...
 [Implementation details: The renderer calls the initOpenGLPrograms() method of the shape
 ...
 <P>
 <LI>
 In its initOpenGLPrograms() method, the OpenGL program to be executed is generated.
 ...
 [Implementation details: The method calls glUseProgram() to apply the OpenGL program generated in initOpenGLPrograms(),
 ...
 <P>
 The code is available at https://github.com/CarstenVogt/AndroidOpenGLLib (but not necessarily the newest version).
 <P><HR><BR>
 ...
 @see de.thkoeln.cvogt.android.opengl_utilities.GLTouchEventCV
 @see de.thkoeln.cvogt.android.opengl_utilities.GLUtilsCV
 @see de.thkoeln.cvogt.android.opengl_utilities.GraphicsUtilsCV
*/
