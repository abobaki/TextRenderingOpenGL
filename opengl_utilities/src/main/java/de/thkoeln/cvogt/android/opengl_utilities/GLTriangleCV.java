...
public class GLTriangleCV {
    ...
    public GLTriangleCV(String id, float[][] vertices) {
        this(id,vertices,GraphicsUtilsCV.white);
    }
    ...
    public GLTriangleCV(String id, float[] vertex0, float[] vertex1, float[] vertex2) {
        this(id,vertex0,vertex1,vertex2,GraphicsUtilsCV.white);
    }
    ...
    public boolean setVertices(float... vertexCoordinates) {
        ...
        vertices[0][0] = vertexCoordinates[0];
        vertices[0][1] = vertexCoordinates[1];
        vertices[0][2] = vertexCoordinates[2];
        vertices[1][0] = vertexCoordinates[3];
        vertices[1][1] = vertexCoordinates[4];
        vertices[1][2] = vertexCoordinates[5];
        vertices[2][0] = vertexCoordinates[6];
        vertices[2][1] = vertexCoordinates[7];
        vertices[2][2] = vertexCoordinates[8];
        return true;
    }
